...
<body>
  ...
  <a href="index.php?route=/table/recent-favorite&db=uas_ecommerce&table=products">
    `uas_ecommerce`.`products`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=uas_ecommerce&table=orders">
    `uas_ecommerce`.`orders`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=uas_ecommerce&table=users">
    `uas_ecommerce`.`users`
  </a>
</li>
<li class="warp_link">
  <a href="index.php?route=/table/recent-favorite&db=platformd&table=pasien">
    `platformd`.`pasien`
  </a>
</li>
...
<div id='pma_navigation_tree_content'>
    ...
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.ZWNvbW1lcmNlX2Ri" data-vpath="cm9vdA==.ZWNvbW1lcmNlX2Ri" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=ecommerce_db"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=ecommerce_db" title="Structure">ecommerce_db</a>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.cGxhdGZvcm1k" data-vpath="cm9vdA==.cGxhdGZvcm1k" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=platformd"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=platformd" title="Structure">platformd</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.dWFzX2Vjb21tZXJjZQ==" data-vpath="cm9vdA==.dWFzX2Vjb21tZXJjZQ==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=uas_ecommerce"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=uas_ecommerce" title="Structure">uas_ecommerce</a>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5b6d35363f2679404b2a213d782b6e64">
